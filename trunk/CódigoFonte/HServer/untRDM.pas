...
type
  TRDM = class(TRemoteDataModule, IRDM)
    ...
    qryGDProd: TZReadOnlyQuery;
    dspGDPro: TDataSetProvider;
    qryLinhaGrade: TZReadOnlyQuery;
    dspLinhaGrade: TDataSetProvider;
    qryGDProdcdgrad: TIntegerField;
    qryGDProddtcada: TDateField;
    qryGDProdcdempr: TIntegerField;
    qryGDProddescri: TStringField;
    qryGDProddeslin: TStringField;
    qryGDProddescol: TStringField;
    qryLinhaGradecdlcgr: TIntegerField;
    qryLinhaGradedtcada: TDateField;
    qryLinhaGradecdempr: TIntegerField;
    qryLinhaGradecdgrad: TIntegerField;
    qryLinhaGradedescri: TStringField;
    qryLinhaGradelincol: TStringField;
    qryNtOpe: TZReadOnlyQuery;
    dspNtOpe: TDataSetProvider;
    qryNtOpedescri: TStringField;
    qryNtOpebxesto: TStringField;
    ...
    qryCtPagcodcon: TIntegerField;
    qryCtPagcdempr: TIntegerField;
    qryCtPagtipcon: TStringField;
    qryCtPagcdclfo: TIntegerField;
    qryCtPagtitulo: TStringField;
    qryCtPagnotcon: TIntegerField;
    qryCtPagdtemit: TDateField;
    qryCtPagvlcont: TFloatField;
    qryCtPagdtvenc: TDateField;
    qryCtPagdtpaga: TDateField;
    qryCtPagvalpag: TFloatField;
    qryCtPagjurpag: TFloatField;
    qryCtPagobscon: TStringField;
    qryCtPagvendco: TIntegerField;
    qryCtPagstacon: TStringField;
    qryCtPaghistor: TStringField;
    qryCtPagcodusu: TIntegerField;
    dspColunaGrade: TDataSetProvider;
    qryColunaGrade: TZReadOnlyQuery;
    ...
    qryTranscdtran: TIntegerField;
    qryTranscdempr: TIntegerField;
    qryTransnmfant: TStringField;
    qryTransdtcada: TDateField;
    qryTransrzsoci: TStringField;
    qryTransendere: TStringField;
    qryTranstelefo: TStringField;
    qryTransfax: TStringField;
    qryTransbairro: TStringField;
    qryTranscidade: TStringField;
    qryTransnumero: TStringField;
    qryTransuf: TStringField;
    qryTranscep: TStringField;
    qryTranscgc: TStringField;
    qryTransinsest: TStringField;
