...
type
  TRDM = class(TRemoteDataModule, IRDM)
    ...
    qryContascodcon: TIntegerField;
    qryContascdempr: TIntegerField;
    qryContastipcon: TStringField;
    qryContascdclfo: TIntegerField;
    qryContastitulo: TStringField;
    qryContasnotcon: TIntegerField;
    qryContasdtemit: TDateField;
    qryContasvlcont: TFloatField;
    qryContasdtvenc: TDateField;
    qryContasdtpaga: TDateField;
    qryContasvalpag: TFloatField;
    qryContasjurpag: TFloatField;
    qryContasobscon: TStringField;
    qryContasstacon: TStringField;
    qryContascdvend: TIntegerField;
