inherited frmManuContasPagar: TfrmManuContasPagar
  ...
  object pgContasPagar: TPageControl [1]
    ...
    object tbPrincipal: TTabSheet
      ...
      object dbeCodFor: TwwDBLookupComboDlg
        Left = 87
        Top = 51
        Width = 134
        Height = 20
        ...
        MaxHeight = 209
        Selected.Strings = (
          'cdforn'#9'10'#9'C'#243'd.'#9'F'#9
          'nmfant'#9'50'#9'Nome Fantasia'#9'F'#9
          'rzsoci'#9'50'#9'rzsoci'#9'F'#9)
        DataField = 'cdclfo'
        DataSource = DataSource
        LookupField = 'cdforn'
        ParentCtl3D = False
      ...
      object pnl_DadosPagamento: TPanel
        Left = -1
        Top = 145
        Width = 523
        Height = 110
