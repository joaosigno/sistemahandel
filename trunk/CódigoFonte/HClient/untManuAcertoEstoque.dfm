  ...
  object pgAcertoEstoqu: TPageControl [2]
    ...
    object tsInicio: TTabSheet
      ...
      object pesquisa: TwwDBLookupComboDlg
        ...
        MaxHeight = 209
        Selected.Strings = (
          'cdprod'#9'10'#9'C'#243'd.'#9'F'#9
          'codfab'#9'15'#9'C'#243'd.Fabrica'#9'F'
          'refere'#9'15'#9'Refer'#234'ncia'#9'F'
          'tipopr'#9'10'#9'Tipo'#9'F'#9
          'descri'#9'50'#9'Descri'#231#227'o'#9'F'#9
          'estatu'#9'10'#9'Est.Atual'#9'F'#9
          'preven'#9'10'#9'Pr.Venda'#9'F'#9)
        ParentCtl3D = False
        TabOrder = 2
        AutoDropDown = False
        ShowButton = True
      ...
      object rxdbceprvendaatual: TRxDBCalcEdit
        Left = 100
        Top = 71
        Width = 115
        Height = 21
      ...
      object exceEstcorreto: TRxDBCalcEdit
        Left = 100
        Top = 111
        Width = 115
        Height = 21
