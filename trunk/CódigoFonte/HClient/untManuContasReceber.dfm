inherited frmManuContasReceber: TfrmManuContasReceber
  Left = 263
  Top = 145
  ...
  object pgCtRec: TPageControl [1]
    ...
    object tsInicio: TTabSheet
      ...
      object dbdeDtEmissao: TDBDateEdit
        Left = 404
        Top = 3
        Width = 112
        Height = 21
      ...
      object dbeCodCaix: TwwDBLookupComboDlg
        Left = 87
        Top = 28
        Width = 134
        Height = 20
        ...
        MaxHeight = 209
        Selected.Strings = (
          'cdcont'#9'13'#9'C'#243'd.'#9'F'#9
          'descri'#9'50'#9'Descri'#231#227'o'#9'F'#9)
        DataField = 'concax'
        DataSource = DataSource
        LookupField = 'cdcont'
        ParentCtl3D = False
        ...
        ShowButton = True
        AllowClearKey = False
        OnExit = dbeCodCaixExit
        OnKeyPress = dbeCodCaixKeyPress
      end
      object dbcbContaCaixa: TDBLookupComboBox
        Left = 224
        Top = 28
        Width = 293
        Height = 20
        Ctl3D = False
        DataField = 'procuraContaCaixa'
        DataSource = DataSource
        ParentCtl3D = False
        TabOrder = 3
      end
      object dbeCodCli: TwwDBLookupComboDlg
        Left = 87
        Top = 51
        Width = 134
        Height = 20
        ...
        OnKeyPress = dbeCodCliKeyPress
      end
      object dblcbClientes: TDBLookupComboBox
        Left = 223
        Top = 51
        Width = 294
        Height = 20
      ...
      object btnDadosPgto: TButton
        ...
        Enabled = False
        TabOrder = 10
        OnClick = btnDadosPgtoClick
      end
      object dbcbxSemPromissoria: TDBCheckBox
        Left = 381
        Top = 113
        Width = 132
        Height = 17
        Caption = 'Sem Duplicata'
        Ctl3D = False
        DataField = 'semdup'
        DataSource = DataSource
        ParentCtl3D = False
  ...
  object dbmmHistorico: TDBMemo [2]
    Left = 7
    Top = 185
    Width = 513
    Height = 92
  ...
  object pnl_DadosPagamento: TPanel [3]
    Left = 1
    Top = 171
    Width = 523
    Height = 110
    ...
    object dbcalcedt_juros: TRxDBCalcEdit
      Left = 385
      Top = 3
      Width = 130
      Height = 21
      Hint = '|Digite o novo valor dos juros pagos para esta conta'
      DataField = 'jurpag'
      DataSource = DataSource
      ReadOnly = True
      ButtonHint = 'Clique para digitar o valor'
      Color = 13425885
      Ctl3D = False
      DisplayFormat = ',0.00'
      GlyphKind = gkCustom
      Glyph.Data = {
        ...
        
    ...
    object dbcalcedt_Desconto: TRxDBCalcEdit
      Left = 91
      Top = 27
      Width = 133
      Height = 21
      Hint = '|Digite o novo valor dos descontos recebidos para esta conta'
      DataField = 'descon'
      DataSource = DataSource
      ReadOnly = True
      ButtonHint = 'Clique para digitar o valor'
    ...
    object dbcalcedt_valorpago: TRxDBCalcEdit
      Left = 385
      Top = 51
      Width = 130
      Height = 21
      Hint = '|Digite o novo valor total pago para esta conta a pagar'
      DataField = 'valpag'
      DataSource = DataSource
      ReadOnly = True
      ButtonHint = 'Clique para digitar o valor'
    ...
    object dbdateedt_datapgto: TDBDateEdit
      Left = 90
      Top = 2
      Width = 134
      Height = 21
      ...
      DataSource = DataSource
      ReadOnly = True
      ButtonHint = 'Clique para escolher a data'
      Color = 13425885
      Ctl3D = False
      GlyphKind = gkCustom
      Glyph.Data = {
    ...
    object rxdbceMulta: TRxDBCalcEdit
      Left = 385
      Top = 27
      Width = 130
      Height = 21
  ...
  object tmr_verificaconta: TTimer
    Interval = 100
    OnTimer = tmr_verificacontaTimer
    Left = 480
    Top = 128
  end
end
