...
begin
  frmPrincipal.Configuracao.EmpresaCodigo := StrToInt(edtEmpresa.Text);
  frmPrincipal.Configuracao.UsuarioCodigo := StrToInt(edtUsuario.Text);
  frmPrincipal.Configuracao.EmpresaNome := lblempresa.Caption;
  frmPrincipal.Configuracao.UsuarioNome := lblusuario.Caption;
  close;
end;
