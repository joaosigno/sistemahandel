inherited frmManuDepAut: TfrmManuDepAut
  ...
  object pgDepAut: TPageControl [1]
    Left = 0
    Top = 0
    Width = 534
    Height = 180
    ...
    object tsDadosPrincipais: TTabSheet
      ...
      object dbcbxDependente: TDBCheckBox
        Left = 136
        Top = 108
        Width = 116
        Height = 17
  ...
  object cdsDepAut: TClientDataSet
    Aggregates = <>
    Params = <>
    ...
    Left = 68
    Top = 137
    object cdsDepAutnome: TStringField
      DisplayLabel = 'Nome'
      FieldName = 'nome'
      ReadOnly = True
      Size = 50
    end
    object cdsDepAutdocume: TStringField
      DisplayLabel = 'Documento'
      FieldName = 'docume'
      ReadOnly = True
    end
    object cdsDepAutcompra: TStringField
      DisplayLabel = 'Comprar?'
      FieldName = 'compra'
      ReadOnly = True
      Size = 1
    end
    object cdsDepAutdtnasc: TDateField
      DisplayLabel = 'Dt.Nasc.'
      FieldName = 'dtnasc'
      ReadOnly = True
    end
    object cdsDepAuttelefo: TStringField
    ...
    object cdsDepAutcdempr: TIntegerField
      FieldName = 'cdempr'
    end
  end
end
