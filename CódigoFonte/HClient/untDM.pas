...
type
  ...
  Tdm = class(TDataModule)
    ...
    cdsCTBan: TClientDataSet;
    cdsCTBancdcont: TIntegerField;
    cdsCTBancdempr: TIntegerField;
    cdsCTBandtcada: TDateField;
    cdsCTBandtaber: TDateField;
    cdsCTBandescri: TStringField;
    cdsCTBanagenci: TStringField;
    cdsCTBannrcont: TStringField;
    cdsCTBancdbanc: TIntegerField;
    cdsCTBantelefo: TStringField;
    cdsCTBanfax: TStringField;
    cdsCTBangerent: TStringField;
    cdsCTBanlimite: TFloatField;
    cdsCTBandtvenc: TDateField;
    cdsCTBanemail: TStringField;
    cdsCTBanhomepa: TStringField;
    cdsCTBanprocuraBanco: TStringField;
