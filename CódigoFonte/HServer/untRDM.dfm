object RDM: TRDM
  ...
  object qryContas: TZReadOnlyQuery
    ...
    Left = 360
    Top = 376
    object qryContascodcon: TIntegerField
      FieldName = 'codcon'
      Required = True
    end
    object qryContascdempr: TIntegerField
      FieldName = 'cdempr'
      Required = True
    end
    object qryContastipcon: TStringField
      FieldName = 'tipcon'
      Required = True
      Size = 1
    end
    object qryContascdclfo: TIntegerField
      FieldName = 'cdclfo'
      Required = True
    end
    object qryContastitulo: TStringField
      FieldName = 'titulo'
      Required = True
      Size = 15
    end
    object qryContasnotcon: TIntegerField
      FieldName = 'notcon'
    end
    object qryContasdtemit: TDateField
      FieldName = 'dtemit'
      Required = True
    end
    object qryContasvlcont: TFloatField
      FieldName = 'vlcont'
    end
    object qryContasdtvenc: TDateField
      FieldName = 'dtvenc'
      Required = True
    end
    object qryContasdtpaga: TDateField
      FieldName = 'dtpaga'
    end
    object qryContasvalpag: TFloatField
      FieldName = 'valpag'
    end
    object qryContasjurpag: TFloatField
      FieldName = 'jurpag'
    end
    object qryContasobscon: TStringField
      FieldName = 'obscon'
      Size = 200
    end
    object qryContasstacon: TStringField
      FieldName = 'stacon'
      Required = True
      Size = 1
    end
    object qryContascdvend: TIntegerField
      FieldName = 'cdvend'
    end
    object qryContasconcax: TStringField
      FieldName = 'concax'
      Required = True
      Size = 13
    end
    object qryContasdescon: TFloatField
      FieldName = 'descon'
    end
    object qryContashistor: TStringField
      FieldName = 'histor'
      Size = 100
    end
