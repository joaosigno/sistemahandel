...
type
  TRDM = class(TRemoteDataModule, IRDM)
    ...
    qryLCGrade: TZReadOnlyQuery;
    dspLCGrade: TDataSetProvider;
    ...
    qryLCGradecdlcgr: TIntegerField;
    qryLCGradedtcada: TDateField;
    qryLCGradecdempr: TIntegerField;
    qryLCGradecdgrad: TIntegerField;
    qryLCGradedescri: TStringField;
    qryLCGradelincol: TStringField;
