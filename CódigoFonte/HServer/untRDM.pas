...
type
  TRDM = class(TRemoteDataModule, IRDM)
    ...
    qryProd: TZReadOnlyQuery;
    qryProdcdprod: TIntegerField;
    qryProdcdempr: TIntegerField;
    qryProdtipopr: TStringField;
    qryProddtcada: TDateField;
    qryProdativo: TStringField;
    qryProddescri: TStringField;
    qryProdcdmarc: TIntegerField;
    qryProdcdgrup: TIntegerField;
    qryProdtipcon: TStringField;
    qryProdunidad: TStringField;
    qryProdestatu: TFloatField;
    qryProdcodfab: TStringField;
    qryProdrefere: TStringField;
    qryProdpreven: TFloatField;
    qryProdestmin: TFloatField;
    qryProdcusrea: TFloatField;
    qryProdpesliq: TFloatField;
    qryProdpesbru: TFloatField;
    qryProdcodncm: TStringField;
    qryProdprzgar: TStringField;
    qryProdmarluc: TFloatField;
    qryProdcusmed: TFloatField;
    qryProdultcom: TDateField;
    qryProdultven: TDateField;
    qryProdclaori: TStringField;
    qryProdsittri: TStringField;
    qryProdicms: TFloatField;
    qryProdipi: TFloatField;
